/*
=====================================================================================================================
Stored Proceduer: load bronze (Source -> Bronze)
=====================================================================================================================
Script Purpose:
...
Parameters:
  None.
This stored procedure does not any parameters or return any values.
...
PRINT'>> Inserting Data Into: bronze.erp_loc_a101_info';
...
PRINT'>> Inserting Data Into: bronze.erp_px_cat_g1v2_info';
...
PRINT'>> Inserting Data Into: bronze.erp_cusgt_az12_info';
